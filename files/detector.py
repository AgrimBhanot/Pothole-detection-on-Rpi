...
Includes vectorized operations, NMS, and ONNX Runtime optimizations
"""
...
class OptimizedYOLODetector:
    """
    High-performance YOLO detector optimized for RPi5
    Features:
    ...
    def __init__(self, model_config: ModelConfig, intra_threads: int = 4, 
        ...
        # Configure ONNX Runtime for RPi5
        ...
        # Pre-allocate preprocessing buffer (zero-copy optimization)
    ...
    def postprocess(self, outputs: List[np.ndarray], frame_shape: Tuple[int, int]) -> Tuple[List[Tuple[int, int, int, int]], List[float]]:
        ...
        # Vectorized confidence filtering (HUGE speed-up)
        ...
        # Convert to xywh format for cv2.dnn.NMSBoxes
        ...
        # Flatten indices (OpenCV returns nested list)
